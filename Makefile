...
fmt:
	...
	@-go run mvdan.cc/gofumpt@v0.10.0 -l -w .
	@-go run golang.org/x/tools/cmd/goimports@v0.46.0 -l -w .
	...
	@-go run golang.org/x/tools/go/analysis/passes/fieldalignment/cmd/fieldalignment@v0.46.0 -test=false -fix ./...
